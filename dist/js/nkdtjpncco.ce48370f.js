import{d as n,o,c,a as d}from"./@vue.01ebc98a.js";const l={class:"markdown-body"},s=d(`<h1>Nginx</h1><h2>\u5B89\u88C5</h2><p>\u5728<a href="https://nginx.org/en/download.html"><code>Nginx\u5B98\u7F51</code></a>\u4E0B\u8F7D\uFF0C\u5E76\u4E0A\u4F20\u81F3\u670D\u52A1\u5668 /root \u8DEF\u5F84\u4E0B, \u4EE5\u4E0B\u662F 1.21.6\u7248\u672C</p><div class="code-wrapper"><div class="heading-row no-heading show-lang"><span class="lang-display"></span></div><div class="code-block language-markdown no-line-numbers" data-lang="" data-modifiers=""><pre class="language-markdown" data-lang=""><code class="code-line odd first-row line-1">tar zxvf nginx-1.21.6.tar.gz // \u89E3\u538B</code>
